...
-- Comparte las tablas category y tag con los productos
...
COMMENT ON TABLE blog_article IS 'Artículos del blog Diario Grimmiz - comparte categorías y etiquetas con productos';
...
COMMENT ON COLUMN blog_article.category_id IS 'ID de la categoría (compartida con productos)';
